...
const Permissions = props => __jsx(external_react_apollo_["Query"], {
  query: ALL_USERS_QUERY
}, ({
  data,
  loading,
  error
}) => __jsx("div", null, __jsx(ErrorMessage["a" /* default */], {
  error: error
}), __jsx("div", null, __jsx("h2", null, "Manage Permissions"), __jsx(styles_Table, null, __jsx("thead", null, __jsx("tr", null, __jsx("th", null, "Name"), __jsx("th", null, "Email"), possiblePermissions.map(permission => __jsx("th", {
  key: permission
}, permission)), __jsx("th", null, "\uD83D\uDC47\uD83C\uDFFB"))), __jsx("tbody", null, data.users.map(user => __jsx(Permissions_UserPermissions, {
  user: user,
  key: user.id
})))))));
...
class Permissions_UserPermissions extends external_react_default.a.Component {
  constructor(...args) {
    ...
    Object(defineProperty["a" /* default */])(this, "handlePermissionChange", event => {
  ...
  render() {
    ...
    return __jsx(external_react_apollo_["Mutation"], {
      ...
      loading,
      error
    }) => __jsx(external_react_default.a.Fragment, null, error && __jsx("tr", null, __jsx("td", {
      colspan: "10"
    ...
    })))), __jsx("td", null, __jsx(StyleButton["a" /* default */], {
      type: "button",
      disabled: loading,
...
var permissions_jsx = external_react_default.a.createElement;



const PermissionsPage = props => permissions_jsx("div", null, permissions_jsx(PleaseSignIn["a" /* default */], null, permissions_jsx(components_Permissions, null)));
