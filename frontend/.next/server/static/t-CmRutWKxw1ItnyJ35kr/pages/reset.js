...
class Reset_Reset extends external_react_["Component"] {
  ...
  render() {
    return __jsx(external_react_apollo_["Mutation"], {
      ...
      disabled: loading,
      "aria-busy": loading
    }, __jsx("h2", null, "Reset Your Password"), __jsx(ErrorMessage["a" /* default */], {
      error: error
    }), __jsx("label", {
      htmlFor: "password"
...
const Sell = props => reset_jsx("div", null, reset_jsx("p", null, "Reset Your Password ", props.query.resetToken), reset_jsx(components_Reset, {
  resetToken: props.query.resetToken
}));

/* harmony default export */ var pages_reset = __webpack_exports__["default"] = (Sell);
