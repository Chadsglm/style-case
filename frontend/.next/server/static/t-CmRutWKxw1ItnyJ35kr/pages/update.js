...
`;
const UPDATE_ITEM_MUTATION = external_graphql_tag_default.a`
...
class UpdateItem_UpdateItem extends external_react_["Component"] {
  constructor(...args) {
    super(...args);
    ...
    Object(defineProperty["a" /* default */])(this, "updateItem", async (event, updateItemMutation) => {
...
const Sell = ({
  query
}) => update_jsx("div", null, update_jsx(components_UpdateItem, {
  id: query.id
}));

/* harmony default export */ var update = __webpack_exports__["default"] = (Sell);
